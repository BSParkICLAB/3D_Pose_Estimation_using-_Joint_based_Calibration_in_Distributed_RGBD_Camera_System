...
//layout(binding = 2) restrict readonly uniform uimage2D colorTexture;
//layout(rgba, binding = 2) restrict readonly uniform uimage2D mainTexture;
...
void main()
{
    ...
    {
        fragmentColor = vertexColor.rgba;
